...
const s = {
  ...
  h1: { margin: '6px 0 8px', fontSize: 34, color: '#082f5a' }, h2: { margin: 0, fontSize: 22, color: '#082f5a' }, h3: { margin: '10px 0 4px', fontSize: 20, color: '#082f5a' },
  ...
  stat: { background: '#fff', border: '1px solid #dde4eb', borderRadius: 14, padding: '18px 20px' }, statValue: { fontSize: 28, fontWeight: 800, color: '#082f5a' }, statLabel: { marginTop: 5, color: '#66788a', fontSize: 13 },
  ...
  days: { display: 'flex', gap: 8, flexWrap: 'wrap' }, dayButton: { border: '1px solid #cfd9e3', background: '#fff', padding: '8px 12px', borderRadius: 8, cursor: 'pointer', color: '#334b63' }, dayActive: { background: '#082f5a', color: '#fff', borderColor: '#082f5a' }, help: { color: '#758697' },
  primaryButton: { border: 0, background: '#082f5a', color: '#fff', padding: '12px 18px', borderRadius: 9, fontWeight: 700, cursor: 'pointer' }, secondaryButton: { border: '1px solid #bfcbd7', background: '#fff', color: '#082f5a', padding: '9px 13px', borderRadius: 8, fontWeight: 700, cursor: 'pointer' }, dangerButton: { border: '1px solid #e1b7b7', background: '#fff5f5', color: '#a12b2b', padding: '9px 13px', borderRadius: 8, fontWeight: 700, cursor: 'pointer' },
