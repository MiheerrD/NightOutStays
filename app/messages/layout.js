...
export default function GuestMessagesPage() {
  ...
  async function initialisePage() {
    ...
    try {
      ...
      /*
        Guests table does not use user_id.
        Guest is matched using login email.
      */
      ...
      if (
        ...
        throw new Error(
          'No guest profile was found for this account.'
        );
      }
  ...
  async function loadMessages(
    ...
    /*
      Mark host/admin messages
      as read when guest opens
      the conversation.
    */
  ...
  async function sendMessage(
    ...
    if (
      ...
      setError(
        'Booking conversation is unavailable.'
      );
  ...
  async function requestDiscount() {
    ...
    if (
      ...
      setError(
        'Please write your discount request.'
      );
    ...
    try {
      /*
        Structured discount request
        is stored as a special
        booking message.

        This does NOT change price.
        Only a host offer accepted
        later will change pricing.
      */
      ...
      /*
        Try to also mark booking as
        discount requested.

        If guest RLS does not allow
        this update, messaging still
        remains safely recorded.
      */
      ...
      if (
        ...
        console.warn(
          'Booking discount flag not updated:',
          bookingUpdateError
        );
      }
      ...
      setNotice(
        'Discount request sent to the host.'
      );
                ...
                <>
                  ...
                  >
                    <div>
                      ...
                      >
                        You can request a discount here. Sending this request does not change your booking price. The host must send a formal special offer, and you will be able to accept or decline it.
                      </p>
                    </div>
                    ...
                    <textarea
                      ...
                      placeholder="Example: Can you offer a better rate for this stay?"
                      style={
                        styles.discountTextarea
                      }
                    />
