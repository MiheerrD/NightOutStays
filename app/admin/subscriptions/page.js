...
const styles = {
  page: { maxWidth: 1550, margin: "0 auto", padding: 28, background: "#f6f8fb", minHeight: "100vh", color: "#17324d", fontFamily: "Arial,sans-serif" },
  ...
  h2: { margin: "0 0 6px", color: "#082f5a" },
  ...
  cardValue: { fontSize: 23, color: "#082f5a" },
  ...
  tabActive: { background: "#082f5a", color: "white", borderColor: "#082f5a" },
  ...
  primary: { border: 0, background: "#082f5a", color: "white", borderRadius: 9, padding: "11px 16px", fontWeight: 800, cursor: "pointer" },
  primarySmall: { border: 0, background: "#082f5a", color: "white", borderRadius: 8, padding: "8px 11px", fontWeight: 700, cursor: "pointer" },
  ...
  rulePrice: { fontSize: 22, fontWeight: 800, color: "#082f5a", marginTop: 13 },
};
