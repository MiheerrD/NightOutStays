...
const s={page:{maxWidth:1550,margin:"0 auto",padding:28,background:"#f6f8fb",minHeight:"100vh",color:"#303a44",fontFamily:"Arial,sans-serif"},head:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:18,marginBottom:20},h1:{fontSize:34,margin:0,color:"#303a44"},h2:{margin:"0 0 8px",color:"#303a44"},sub:{margin:"7px 0 0",color:"#66788a"},help:{color:"#66788a",fontSize:13},cards:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(165px,1fr))",gap:12,marginBottom:18},card:{background:"white",border:"1px solid #dfe6ee",borderRadius:14,padding:17},cardLabel:{display:"block",fontSize:12,color:"#718396",marginBottom:8},cardValue:{fontSize:22,color:"#303a44"},tabs:{display:"flex",gap:8,flexWrap:"wrap",marginBottom:16},tab:{border:"1px solid #d5dee8",background:"white",color:"#214e78",borderRadius:10,padding:"10px 14px",fontWeight:700,cursor:"pointer"},tabOn:{background:"#303a44",color:"white"},panel:{background:"white",border:"1px solid #dfe6ee",borderRadius:15,padding:20,marginBottom:18},filters:{display:"grid",gridTemplateColumns:"minmax(250px,1fr) 220px",gap:10,marginBottom:14},input:{width:"100%",boxSizing:"border-box",padding:"11px 12px",border:"1px solid #cfd9e4",borderRadius:9,background:"white"},select:{width:"100%",boxSizing:"border-box",padding:"11px 12px",border:"1px solid #cfd9e4",borderRadius:9,background:"white"},grid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:13},field:{display:"flex",flexDirection:"column",gap:6,fontSize:12,fontWeight:700,color:"#53687b"},primary:{border:0,background:"#303a44",color:"white",borderRadius:9,padding:"11px 16px",fontWeight:800,cursor:"pointer"},primarySmall:{border:0,background:"#303a44",color:"white",borderRadius:8,padding:"8px 10px",fontWeight:700,cursor:"pointer"},danger:{border:"1px solid #d99",background:"white",color:"#9b1c1c",borderRadius:8,padding:"8px 10px",fontWeight:700,cursor:"pointer"},err:{background:"#fff0f0",border:"1px solid #f0c9c9",color:"#9b1c1c",borderRadius:10,padding:12,marginBottom:14},ok:{background:"#eef9f1",border:"1px solid #cde8d4",color:"#166534",borderRadius:10,padding:12,marginBottom:14},tableWrap:{overflowX:"auto"},table:{width:"100%",borderCollapse:"collapse",minWidth:1050},th:{textAlign:"left",padding:11,background:"#f8fafc",borderBottom:"1px solid #e5ebf1",fontSize:12,color:"#607487"},td:{padding:12,borderBottom:"1px solid #edf1f4",verticalAlign:"top",fontSize:13},small:{display:"block",marginTop:5,fontSize:11,color:"#748698",fontWeight:400},badge:{display:"inline-block",background:"#eaf2fb",color:"#214e78",borderRadius:999,padding:"6px 9px",fontSize:11,fontWeight:700},actions:{display:"flex",gap:6,flexWrap:"wrap"},empty:{padding:30,textAlign:"center",color:"#748698"},ruleGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(290px,1fr))",gap:13,marginTop:15},ruleCard:{border:"1px solid #e0e7ef",borderRadius:13,padding:15},row:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10},price:{fontSize:21,fontWeight:800,color:"#303a44",marginTop:14}};
