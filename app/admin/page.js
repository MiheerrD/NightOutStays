          ...
          <section style={s.detail}>
            {!ticket ? (
              ...
              <>
                ...
                {isClosed && <div style={s.closed}>Ticket Closed — no further replies can be sent unless you reopen it.</div>}
...
const s = {
  ...
  closed: { marginTop: 10, background: "#f1f5f9", color: "#334155", padding: 12, borderRadius: 9, fontWeight: 800 },
