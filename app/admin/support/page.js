...
const s = {
  page: { maxWidth: 1500, margin: "auto", padding: 28, background: "#f6f8fb", minHeight: "100vh", fontFamily: "Arial", color: "#303a44" },
  ...
  h2: { color: "#303a44", margin: "0 0 8px" },
  ...
  statusOpen: { color: "#d9006c", background: "#fff4f9", borderColor: "#ffd9eb" },
  sub: { color: "#6b7c8e" },
  ...
  linkBtn: { background: "#fff", border: "1px solid #cbd5e1", color: "#303a44", borderRadius: 9, padding: "10px 14px", textDecoration: "none", fontWeight: 700 },
  ...
  tabOn: { background: "#303a44", color: "#fff" },
  ...
  filterSelect: { width: "100%", padding: "10px 11px", border: "1px solid #cbd5e1", borderRadius: 8, background: "#fff", color: "#303a44", fontWeight: 700, cursor: "pointer" },
  filterCount: { display: "block", marginTop: 6, color: "#64748b" },
  noFilterResults: { padding: 24, textAlign: "center", color: "#64748b", fontSize: 13 },
  ticket: { width: "100%", textAlign: "left", border: 0, borderBottom: "1px solid #edf1f4", background: "#fff", padding: 13, cursor: "pointer", display: "grid", gap: 5, color: "#303a44" },
  ...
  saving: { marginTop: 10, background: "#fff4f9", color: "#d9006c", padding: 10, borderRadius: 8, fontWeight: 700 },
  ...
  reopenBtn: { background: "#303a44", color: "#fff", border: 0, borderRadius: 9, padding: "10px 14px", fontWeight: 800, cursor: "pointer" },
  btn: { background: "#303a44", color: "#fff", border: 0, borderRadius: 9, padding: "11px 14px", fontWeight: 800, cursor: "pointer" },
